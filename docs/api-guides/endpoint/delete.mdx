...
description: 'Example code for deleting data from a table using the table API endpoint.'
---

## Overview

`table.delete()` is used to delete data from a table using the table API endpoint.

<CardGroup cols={1}>
  <Card
    title="Delete API example"
    icon="code"
    href="https://github.com/Ahen-Studio/skypy-db/blob/main/examples/basic_implementation/example_delete.py"
  >
    Example code for deleting data from a table using the table API endpoint.
  </Card>
</CardGroup>
